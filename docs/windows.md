...
The ZIP excludes disc images and saves, but its compiled game assembly is derived from the original game. Keep this development artifact private; do not attach it to public releases or commit it. Build scripts and this document contain no game data.
